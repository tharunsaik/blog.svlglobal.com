...
<html lang="en">
	...
	<body>
		<div class="container">
		  ...
		  <div class="card border-0 mb-5 text-white rounded bg-dark">
			  <img src="https://picsum.photos/id/551/1920/800" alt="" class="card-img">
			...
			<div class="col-md-6">
			  <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
				...
				<div class="col-auto d-none d-lg-block">
				  <img src="https://picsum.photos/id/376/200/250" alt="">
				</div>
			  </div>
			</div>
			<div class="col-md-6">
			  <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
				...
				<div class="col-auto d-none d-lg-block">
					<img src="https://picsum.photos/id/111/200/250" alt="">
				</div>
			  </div>
			</div>
		  </div>
		...
		<footer class="blog-footer">
		  <p>Blog template built for <a href="http://staging.svlglobal.com/">SVL Global</a> by <a href="http://staging.svltechnolabs.com/">Techno Labs</a>.</p>
		  <p>
			<a href="#">Back to top</a>
		  </p>
		</footer>
		<!-- Navbar Start -->
		<nav class="navbar navbar-expand-lg navbar-light bg-transparent" id="navbarMain">
			<div class="container">
